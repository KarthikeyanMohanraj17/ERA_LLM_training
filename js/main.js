document.addEventListener("DOMContentLoaded", () => {
  ...
  initDeltaRule(document.getElementById("w-deltanet"), { level: "parallel" });
  initDeltaRule(document.getElementById("w-gated-deltanet"), { level: "gated" });
  initTopK(document.getElementById("w-nsa"), { defaultK: 4 });
  initTopK(document.getElementById("w-dsa"), { defaultK: 3 });
